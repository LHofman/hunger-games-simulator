...
providers: list[ProviderType] = [
    ...
    ({
        ...
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 1' }] },
        'expected_has_required_possessions': True,
    }),
    ({
        'id': 'an event with a required possession that the tribute does not have cannot be played',
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 3' }] },
    ...
    ({
        ...
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 3', 'inverse': True }] },
        'expected_has_required_possessions': True,
    }),
    ({
        'id': 'an event with a required possession that the tribute has but is negated cannot be played',
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 1', 'inverse': True }] },
        'expected_has_required_possessions': False,
    }),
    ({
        'id': 'an event with multiple required possessions that the tribute has can be played',
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 1' }, { 'player': 1, 'type': 'item', 'value': 'Test Item 2' }] },
        'expected_has_required_possessions': True,
    }),
    ({
        'id': 'an event with multiple required possessions that the tribute does not have cannot be played',
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 1' }, { 'player': 1, 'type': 'item', 'value': 'Test Item 3' }] },
        'expected_has_required_possessions': False,
    }),
    ({
        'id': 'an event with multiple required possessions that the tribute has and does not have but is negated can be played',
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 1' }, { 'player': 1, 'type': 'item', 'value': 'Test Item 3', 'inverse': True }] },
        'expected_has_required_possessions': True,
    }),
    ({
        'id': 'an event with multiple required possessions that the tribute has and does have but is negated cannot be played',
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 1' }, { 'player': 1, 'type': 'item', 'value': 'Test Item 2', 'inverse': True }] },
        'expected_has_required_possessions': False,
    }),
    ({
        ...
        'event': { **default_event, 'name': 'Test Event', 'requires_possessions': [{ 'player': 1, 'type': 'item', 'value': 'Test Item 3' }, { 'player': 1, 'type': 'item', 'value': 'Test Item 4', 'inverse': True }] },
        'expected_has_required_possessions': False,
    }),
]
